...
// Here I've changed "load('OccupancyMap_v1.mat');" to:
loadmatfile("OccupancyMap_v1.mat"); // This allows me to take MATLAB's occupancy
                                    // map data and use it in Scilab.
...
exec("PlotOccupancyMap.sce") // Scilab requires you to run files before you can call them
...
// As stated before, Scilab needs you to execute files before you can call them
exec("moveRobot.sce");
exec("TestMovement.sce");
